...
public class CasSetSupplier implements Supplier<CasSet> {
  public static class BakoCas extends Cas {
    ...
    protected String nom() {
      return "Cas de Bako: Projection de son patrimoine au 31 Décembre";
    }
    ...
    public Set<Possession> possessions() {
      new FluxArgent("BNI", bni, getAjd(), getFinSimulation(), 2, ariary(2_125_000));
      new FluxArgent("BNI -> BMOI", bni, salaryStart, getFinSimulation(), 3, ariary(-200_000));
      new FluxArgent(
          "Virement mensuel BMOI", bmoi, salaryStart, getFinSimulation(), 3, ariary(200_000));
      ...
      var PC = new Materiel("Ordinateur de Bako", salaryStart, getAjd(), ariary(3_000_000), -0.12);
