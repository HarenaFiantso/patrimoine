...
public class PatrimoineDeTiana implements Supplier<Patrimoine> {
  ...
  public Patrimoine get() {
    ...
    return Patrimoine.of(
        "Cas de Tiana: Patrimoine de Tiana au 31 décembre 2026", MGA, AU_8_AVRIL_2025, Tiana, possessionsDeTianaAu8Avril2025());
  }
  ...
  private static Set<Possession> possessionsDeTianaAu8Avril2025() {
    ...
    var terrain =
        new Materiel("Terrain bati", AU_8_AVRIL_2025, AU_8_AVRIL_2025, ariary(100_000_000), 0.10);
    ...
    var pretBancaire =
        new FluxArgent("Prêt banque", compteBancaire, AU_27_JUILLET_2025, ariary(20_000_000));
